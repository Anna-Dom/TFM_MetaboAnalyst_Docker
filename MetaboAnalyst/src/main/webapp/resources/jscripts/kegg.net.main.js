    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (type === "[mum]") {
                ...
                loadGseaCompoundEnrichTable("mummichog_query.json");
            } else {
                loadIntegCompoundEnrichTable("mummichog_query.json");
            }
...
function setupKeggNet() {
    ...
    var net_path = '/MetaboAnalyst/faces/resources/libs/network/ko01100_map_2021.json';

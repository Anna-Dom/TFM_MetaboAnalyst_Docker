...
function showPCA3DLoading() {
    $.getJSON('/MetaboAnalyst' + document.getElementById("mydir2").value,
            function (raw_data) {
                ...
                uploadImage('canvas2', 'loadings3D');
            });
}
;

function uploadImage(graphDiv, graphNm) {
    ...
    $.ajax({
        ...
        data: {function: 'decodeImageData', data: dataURL, name: graphNm},
        async: false,
        cache: false,
        error: function () {

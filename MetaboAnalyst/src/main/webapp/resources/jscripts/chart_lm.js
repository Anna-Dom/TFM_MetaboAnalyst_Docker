...
function initChart() {
    ...
    const logp_thresh = parseFloat(-Math.log10(document.getElementById('form1:covP').value));
                    ...
                    options: {
                        ...
                        scales: {
                            y: {
                                title: {
                                    display: true,
                                    text: '-log10(P-value): covariate adjustment'
                                },
                                ticks: {
                                    stepSize: step
                                }
                            ...
                            x: {
                                title: {
                                    display: true,
                                    text: '-log10(P-value): no covariate adjustment'
                                },
                                ticks: {
                                    stepSize: step
                                }

...
function initHeatMapFunctions() {
        ...
        $('#dg2').datagrid({
            onSelect: function (index, row) {
                ...
                if (annot_arr.length > 10) {
                    alert("A maximum of 10 pathways can be highlighted at the same time");
                    unselType = "limit"
    ...
    $('#viewOpt').change(function () {
        ...
        if (viewOpt === "focus") {
            ...
            if ($('#results-wrap').length) {
                ...
                alert("Custom view not created yet!");
                return false;
            }
        } else { //overview
    ...
    function download_image(view) {
        ...
        if (view === 'overview') { //overview 
            ...
            alert("You must first create a custom heatmap using the Heatmap builder!");
            return;
        }
        ...
        if ($('#results-wrap').length) {//test if exists
            ...
            main_map.hover.ondblclick = function (e) {
                ...
                if (inx == -1) {
                    ...
                    alert("The item is already included at row " + (inx + 1))
                }
            };
            ...
            function main_mouseup(e) {
                if (main_drag_flag) {
                    ...
                    if (dupgenes != '') {
                        alert(dupgenes + ' are ignored. They have already been included in your previous selections.')
                    }

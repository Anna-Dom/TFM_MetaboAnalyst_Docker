...
} from 'https://cdn.skypack.dev/pin/d3-force-3d@v3.0.3-hRrAfCiaQZq1lEU5hneZ/mode=imports,min/optimized/d3-force-3d.js';


import graph from 'https://cdn.skypack.dev/ngraph.graph';
import forcelayout from 'https://cdn.skypack.dev/ngraph.forcelayout';
const ngraph = { graph, forcelayout };

import Kapsule from './kapsule.module.js';
import accessorFn from './accessor-fn.module.js';

import { min as d3Min, max as d3Max } from 'https://cdn.skypack.dev/d3-array@3';

import threeDigest from './utils/three-digest.js';
import { emptyObject } from './utils/three-gc.js';
import { autoColorObjects, colorStr2Hex, colorAlpha } from './utils/color-utils.js';
import getDagDepths from './utils/dagDepths.js';

...
import { forceSimulation, forceLink, forceManyBody, forceCenter, forceRadial } from 'https://cdn.skypack.dev/pin/d3-force-3d@v3.0.3-hRrAfCiaQZq1lEU5hneZ/mode=imports,min/optimized/d3-force-3d.js';
import graph from 'https://cdn.skypack.dev/pin/ngraph.graph@v20.0.0-DnN3l8NewMJhsqvSalCJ/mode=imports,min/optimized/ngraph.graph.js';
import forcelayout from 'https://cdn.skypack.dev/pin/ngraph.forcelayout@v3.3.0-z7SYq9ahR6UkOJqz4Apf/mode=imports,min/optimized/ngraph.forcelayout.js';
import Kapsule from './kapsule.module.js';
import accessorFn from './accessor-fn.module.js';
import { min, max } from 'https://cdn.skypack.dev/pin/d3-array@v3.1.6-gfblLE9ij08kxMllvvWU/mode=imports,min/optimized/d3-array.js';
import dataJoint from './data-joint.module.js';
import { scaleOrdinal } from 'https://cdn.skypack.dev/pin/d3-scale@v4.0.2-qUv67mnQQKwRMEsPRKcO/mode=imports,min/optimized/d3-scale.js';
import { schemePaired } from 'https://cdn.skypack.dev/pin/d3-scale-chromatic@v3.0.0-wlyjJbUexgtDqhQ6ksVy/mode=imports,min/optimized/d3-scale-chromatic.js';
import tinycolor from 'https://cdn.skypack.dev/pin/tinycolor2@v1.4.2-90pyEk3KdnygdORggTDm/mode=imports,min/optimized/tinycolor2.js';
